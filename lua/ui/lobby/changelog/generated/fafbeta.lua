...
Changelog = {
    ...
    Description = {
        ...
        "",
        "This game mode is for testing new features or balance changes. The changes here are subject to change and may be modified again or removed",
        "entirely.",
        "",
        "## Balance",
        "",
